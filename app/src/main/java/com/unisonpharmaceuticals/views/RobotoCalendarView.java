...
public class RobotoCalendarView extends LinearLayout {
    ...
    public void clearSelectedDay() {
        if (lastSelectedDayCalendar != null) {
            ...
            dayOfTheMonth.setTypeface(AppUtils.getTypefaceRegular(context));
    ...
    private void setUpDaysOfMonthLayout() {
        ...
        for (int i = 1; i < 43; i++) {
            ...
            dayOfTheMonthText.setTypeface(AppUtils.getTypefaceRegular(context));
