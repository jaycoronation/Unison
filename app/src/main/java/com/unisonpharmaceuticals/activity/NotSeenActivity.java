...
import com.unisonpharmaceuticals.fragment.FragmentNotSeenEntry;
import com.unisonpharmaceuticals.fragment.FragmentNotSeenReport;
...
public class NotSeenActivity extends BaseClass 
{
    ...
    private String[] tabsTitle = {"Not Seen Entry", "Not Seen Report"};
    ...
    public void initViews() {
        ...
        tvTitle.setText("NOT SEEN ENTRY");
    ...
    public void viewClick() {
        viewpager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position)
            {
                ...
                {
                    tvTitle.setText("NOT SEEN REPORT");
                }
            }
    ...
    private void setupViewPager(ViewPager viewPager)
    {
        ...
        adapter.addFragment(new FragmentNotSeenEntry());
        adapter.addFragment(new FragmentNotSeenReport());
