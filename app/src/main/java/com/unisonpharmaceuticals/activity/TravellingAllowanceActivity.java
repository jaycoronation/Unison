...
import com.unisonpharmaceuticals.fragment.FragmentTANew;
import com.unisonpharmaceuticals.fragment.FragmentTravelingAllowanceReport;
...
public class TravellingAllowanceActivity extends BaseClass
{
    ...
    private String[] tabsTitle = {"TA Entry", "TA Report"};
    ...
    public void initViews() {
        findViewById(R.id.ivBack).setOnClickListener(new View.OnClickListener() {
            ...
            {
                AppUtils.hideKeyboard(tvTitle,activity);
                activity.finish();
                finishActivityAnimation(activity);
            }
        });
        tvTitle.setText("TA ENTRY");
    ...
    private void setupViewPager(ViewPager viewPager)
    {
        ...
        adapter.addFragment(new FragmentTANew());
        adapter.addFragment(new FragmentTravelingAllowanceReport());
