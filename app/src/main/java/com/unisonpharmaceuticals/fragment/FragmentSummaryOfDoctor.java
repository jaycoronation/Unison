...
public class FragmentSummaryOfDoctor extends Fragment implements View.OnClickListener
{
    ...
    {
		rootView = inflater.inflate(R.layout.fragment_dr_summary, container, false);
    ...
    public void onClick(View v)
    {
        ...
        switch (v.getId())
        {
            ...
            case R.id.tvGenerateReport:
                ...
                {
                    String url = ApiClient.DR_SUMMARY_REPORT + "staff_id="+selectedStaffId+"&month="+selectedMonth+"&year="+selectedYear+"&session_id="+sessionManager.getUserId();
                    Intent intent = new Intent(activity,WebViewActivity.class);
                    intent.putExtra("cameFrom",ApiClient.REPORT_DR_SUMMARY);
