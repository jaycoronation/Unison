...
import com.unisonpharmaceuticals.sugar.com.orm.annotation.Table;
...
import com.unisonpharmaceuticals.sugar.com.orm.inflater.EntityInflater;
...
import com.unisonpharmaceuticals.sugar.com.orm.util.SugarCursor;

import java.lang.reflect.Field;
import java.util.*;

import static com.unisonpharmaceuticals.sugar.com.orm.SugarContext.getSugarContext;

public class SugarRecord<D extends SugarRecord> {
    ...
    static long save(SQLiteDatabase db, Object object) {
        ...
        if (object.getClass().isAnnotationPresent(Table.class)) {
            ...
            ((SugarRecord<SugarRecord>) object).setId(id);
        }
    ...
    public static boolean delete(Object object) {
        ...
        if (type.isAnnotationPresent(Table.class)) {
            ...
            return ((SugarRecord<SugarRecord>) object).delete();
        } else {
            if(ManifestHelper.isDebugEnabled()) {
