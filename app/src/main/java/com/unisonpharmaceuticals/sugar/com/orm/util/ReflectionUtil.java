package com.unisonpharmaceuticals.sugar.com.orm.util;
...
import com.unisonpharmaceuticals.sugar.com.orm.annotation.Ignore;
...
import com.unisonpharmaceuticals.sugar.com.orm.helper.MultiDexHelper;
        ...
        try {
            ...
            if (columnType.isAnnotationPresent(Table.class)) {
                ...
                values.put(columnName,
                        (columnValue != null)
                                ? String.valueOf(((SugarRecord<SugarRecord>) columnValue).getId())
                                : "0");
            } else {
